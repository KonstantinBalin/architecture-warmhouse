...
- При обновлении сиситемы, система будет недоступна всем пользователям
- Используется pull модель, сервер опрашивает датчики
- Зависимость от выездов специалистов

### 5. Визуализация контекста системы — диаграмма С4
[SmartHouse Context Diagram](https://github.com/KonstantinBalin/architecture-warmhouse/blob/warmhouse/diagrams/context/smart_house_context_as_is.puml)
...
[SmartHouse Container Diagram](https://github.com/KonstantinBalin/architecture-warmhouse/blob/warmhouse/diagrams/context/smart_house_container.puml)

**Диаграмма компонентов (Components)**

[SmartHouse Component Diagram](https://github.com/KonstantinBalin/architecture-warmhouse/blob/warmhouse/diagrams/context/smart_house_component.puml)

**Диаграмма кода (Code)**

[SmartHouse Code Diagram](https://github.com/KonstantinBalin/architecture-warmhouse/blob/warmhouse/diagrams/context/smart_house_code.puml)

# Задание 3. Разработка ER-диаграммы

[SmartHouse ER Diagram](https://github.com/KonstantinBalin/architecture-warmhouse/blob/warmhouse/diagrams/er/smart_house_er.puml)
...
Основные протоколы это HTTPS + Websocket
HTTPS предназначен для синхронных запросов
Websocket для стриминга данных с датчикоа на клиент
...
[SmartHouse API](https://github.com/KonstantinBalin/architecture-warmhouse/blob/warmhouse/api/smarthome-api.postman_collection.yaml)
